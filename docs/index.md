...
#jvjrueoayr .gt_column_spanner_outer:first-child {
  padding-left: 0;
}
...
#jvjrueoayr .gt_from_md > :first-child {
  margin-top: 0;
}
...
#jvjrueoayr .gt_grand_summary_row {
  color: #333333;
  background-color: #FFFFFF;
  text-transform: inherit;
  padding-top: 8px;
